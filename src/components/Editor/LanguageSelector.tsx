    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <motion.button
                ...
                className={`group relative flex items-center gap-3 px-4 py-2.5 bg-card/80 
                    rounded-lg transition-all duration-200 border border-border hover:border-primary
            ...
            >
                ...
                <span className="text-foreground min-w-[80px] text-left group-hover:text-primary transition-colors">
                    {currentLanguage.label}
                </span>

                <ChevronDownIcon
                    className={`size-4 text-muted-foreground transition-all duration-300 group-hover:text-primary
                        ${isOpen ? "rotate-180" : ""}`}
                />
            </motion.button>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full left-0 mt-2 w-64 bg-card/95 backdrop-blur-xl
